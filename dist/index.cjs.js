...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement("img", { width: "281px", height: "50px", src: logoImg }));
};
...
var StyledBlank = styled__default['default'].div(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n  width: 100px;\n  height: 50px;\n"], ["\n  width: 100px;\n  height: 50px;\n"])));
var Logo$1 = function (_a) {
    var isPushed = _a.isPushed, isMobile = _a.isMobile, togglePush = _a.togglePush, isDark = _a.isDark, href = _a.href;
    var isAbsoluteUrl = href.startsWith("http");
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(Logo, { className: "desktop-icon", isDark: isDark })));
    return (React__default['default'].createElement(Flex, null,
        isMobile ? (React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$P, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$O, { width: "24px", color: "textSubtle" })))) : (React__default['default'].createElement(StyledBlank, null)),
...
var links = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Github",
                href: "https://github.com/OpenSaleDefi/",
                target: '_blank',
            },
            {
                label: "Docs",
...
var MenuEntry = styled__default['default'].div(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n  \n  ", " {\n    box-shadow: ", ";  \n  }\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 400% 100%;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n  \n  ", " {\n    box-shadow: ", ";  \n  }\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 400% 100%;\n  }\n"])), MENU_ENTRY_HEIGHT, function (_a) {
    ...
    return (secondary ? theme.colors.nav : "transparent");
}, function (_a) {
    var theme = _a.theme;
...
var StyledMenuEntry = styled__default['default'](MenuEntry)(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n  height: 48px;\n\n  ", " {\n    height: 100%;\n  }\n"], ["\n  height: 48px;\n\n  ", " {\n    height: 100%;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
});
var Accordion = function (_a) {
    ...
    var handleMouseLeave = function () {
        console.log('-- handleMouseLeave isOpen : ', isOpen);
        if (isOpen) {
            setIsOpen(function (prevState) { return !prevState; });
        }
    };
    return (React__default['default'].createElement(Container$2, { onMouseLeave: handleMouseLeave },
        React__default['default'].createElement(StyledMenuEntry, { onClick: handleClick, className: className },
...
var MenuLink = function (_a) {
    ...
    var isSoon = href === null || href === void 0 ? void 0 : href.startsWith("soon");
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    if (isHttpLink) {
        var Tag_1 = "a";
        var props_1 = { href: href };
        return React__default['default'].createElement(Tag_1, __assign({}, props_1, otherProps));
    }
    if (isSoon) {
        var Tag_2 = "a";
        return React__default['default'].createElement(Tag_2, __assign({}, otherProps));
    }
    var Tag = reactRouterDom.NavLink;
    var props = { to: href };
...
var StyledMenuEntry$1 = styled__default['default'](MenuEntry)(templateObject_2$f || (templateObject_2$f = __makeTemplateObject(["\n  height: 48px;\n\n  ", " {\n    height: 100%;\n  }\n"], ["\n  height: 48px;\n\n  ", " {\n    height: 100%;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
});
var StyledSoon = styled__default['default'].span(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  background-color: #0095ff;\n  color: #fff;\n  font-size: 12px;\n  margin-left: 10px;\n  border-radius: 5px;\n  padding: 2px 3px;\n"], ["\n  background-color: #0095ff;\n  color: #fff;\n  font-size: 12px;\n  margin-left: 10px;\n  border-radius: 5px;\n  padding: 2px 3px;\n"])));
        ...
        if (entry.items) {
            ...
            return (React__default['default'].createElement(Accordion$1, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: initialOpenState, className: calloutClass }, isPushed &&
                entry.items.map(function (item) { return (React__default['default'].createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                    React__default['default'].createElement(MenuLink, { href: item.href, target: item.target, style: { justifyContent: 'space-between' } },
                        item.label,
                        item.href === "soon" ? React__default['default'].createElement(StyledSoon, null, "soon") : null))); })));
        }
        return (React__default['default'].createElement(StyledMenuEntry$1, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React__default['default'].createElement(MenuLink, { href: entry.href, target: entry.target, onClick: handleClick },
                ...
                entry.href === "soon" ? React__default['default'].createElement(StyledSoon, null, "soon") : null)));
    })));
};
...
var PriceLink = styled__default['default'].a(templateObject_1$F || (templateObject_1$F = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n\n  ", " {\n    border-radius: 10px;\n    border-top-right-radius: 0;\n    border-bottom-right-radius: 0;\n\n    padding: 0 15px;\n    background-color: ", ";\n    color: ", ";\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n\n  ", " {\n    border-radius: 10px;\n    border-top-right-radius: 0;\n    border-bottom-right-radius: 0;\n\n    padding: 0 15px;\n    background-color: ", ";\n    color: ", ";\n  }\n"])), function (_a) {
    ...
    var theme = _a.theme;
    return theme.colors.priceBackground;
}, function (_a) {
    var theme = _a.theme;
    return theme.colors.background;
});
var PriceText = styled__default['default'](Text)(templateObject_2$g || (templateObject_2$g = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.card;
});
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, null,
        ...
        React__default['default'].createElement(PriceText, { color: "text", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
var CakePrice$1 = React__default['default'].memo(CakePrice);
var templateObject_1$F, templateObject_2$g;

var Container$4 = styled__default['default'](Flex)(templateObject_1$G || (templateObject_1$G = __makeTemplateObject(["\n  margin-left: 24px;\n  margin-right: 0;\n\n  ", " {\n    margin-left: 0;\n    margin-right: 24px;\n  }\n"], ["\n  margin-left: 24px;\n  margin-right: 0;\n\n  ", " {\n    margin-left: 0;\n    margin-right: 24px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
});
var Icons$1 = IconModule;
var SocialLinks = function () { return (React__default['default'].createElement(Container$4, null, socials.map(function (social, index) {
...
var templateObject_1$H, templateObject_2$h, templateObject_3$9;
...
var StyledPanel$1 = styled__default['default'].div(templateObject_1$J || (templateObject_1$J = __makeTemplateObject(["\n  position: absolute;\n  left: 0;\n  top: 100px;\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  flex-shrink: 0;\n  transition: padding-top 0.2s, width 0.2s;\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n  background-color: ", ";\n  height: 100vh;\n\n  ", " {\n    position: relative;\n    background-color: unset;\n    height: 100%;\n    top: 0;\n  }\n"], ["\n  position: absolute;\n  left: 0;\n  top: 100px;\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  flex-shrink: 0;\n  transition: padding-top 0.2s, width 0.2s;\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n  background-color: ", ";\n  height: 100vh;\n\n  ", " {\n    position: relative;\n    background-color: unset;\n    height: 100%;\n    top: 0;\n  }\n"])), function (_a) {
    var isPushed = _a.isPushed;
    return (isPushed ? "initial" : "hidden");
}, function (_a) {
    var theme = _a.theme;
...
var PanelHorizontal = function (props) {
    var isPushed = props.isPushed, showMenu = props.showMenu;
...
var StyledButton$1 = styled__default['default'](Button)(templateObject_1$M || (templateObject_1$M = __makeTemplateObject(["  \n\n  ", " {\n    border-radius: 10px;\n    border-top-left-radius: 0;\n    border-bottom-left-radius: 0;\n    border-width: 0;\n    height: 35px;\n    box-shadow: unset;\n  }\n"], ["  \n\n  ", " {\n    border-radius: 10px;\n    border-top-left-radius: 0;\n    border-bottom-left-radius: 0;\n    border-width: 0;\n    height: 35px;\n    box-shadow: unset;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
});
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(StyledButton$1, { scale: "sm", variant: "tertiary", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React__default['default'].createElement(StyledButton$1, { scale: "sm", onClick: function () {
...
var Wrapper$1 = styled__default['default'].div(templateObject_1$N || (templateObject_1$N = __makeTemplateObject(["\n  position: relative;\n  width: 100%;\n"], ["\n  position: relative;\n  width: 100%;\n"])));
var StyledNav = styled__default['default'].nav(templateObject_2$j || (templateObject_2$j = __makeTemplateObject(["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"])), function (_a) {
    var showMenu = _a.showMenu;
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, chainId = _a.chainId, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, links = _a.links, children = _a.children;
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            React__default['default'].createElement(Logo$2, { isPushed: isPushed, isMobile: isMobile, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
            !isMobile && React__default['default'].createElement(PanelHorizontal, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links }),
            React__default['default'].createElement(Flex, { style: { marginLeft: 'auto' } },
                !isMobile && React__default['default'].createElement(SocialLinks$1, null),
                !isMobile && React__default['default'].createElement(CakePrice$1, { cakePriceUsd: cakePriceUsd }),
                React__default['default'].createElement(UserBlock$1, { account: account, login: login, logout: logout, chainId: chainId }))),
        React__default['default'].createElement(BodyWrapper, null,
            isMobile && React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links }),
            React__default['default'].createElement(Inner, { isPushed: isPushed, showMenu: showMenu }, children),
            React__default['default'].createElement(MobileOnlyOverlay, { show: isPushed, onClick: function () { return setIsPushed(false); }, role: "presentation" }))));
};
var templateObject_1$N, templateObject_2$j, templateObject_3$a, templateObject_4$3, templateObject_5$1;

var StyledLink$2 = styled__default['default'](reactRouterDom.Link)(templateObject_1$O || (templateObject_1$O = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 156px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 156px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
}, function (_a) {
    var theme = _a.theme;
...
var StyledNav$1 = styled__default['default'].nav(templateObject_2$k || (templateObject_2$k = __makeTemplateObject(["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"])), function (_a) {
    var showMenu = _a.showMenu;
    return (showMenu ? 0 : "-" + MENU_HEIGHT + "px");
}, MENU_HEIGHT, function (_a) {
    var theme = _a.theme;
...
var BodyWrapper$1 = styled__default['default'].div(templateObject_3$b || (templateObject_3$b = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n"], ["\n  position: relative;\n  display: flex;\n"])));
...
var templateObject_1$P, templateObject_2$k, templateObject_3$b, templateObject_4$4;
...
var alertTypeMap = (_a$3 = {},
    ...
    _a$3);
var StyledToast = styled__default['default'].div(templateObject_1$Q || (templateObject_1$Q = __makeTemplateObject(["\n  right: 16px;\n  position: fixed;\n  max-width: calc(100% - 32px);\n  transition: all 250ms ease-in;\n  width: 100%;\n\n  ", " {\n    max-width: 400px;\n  }\n"], ["\n  right: 16px;\n  position: fixed;\n  max-width: calc(100% - 32px);\n  transition: all 250ms ease-in;\n  width: 100%;\n\n  ", " {\n    max-width: 400px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
...
var StyledToastContainer = styled__default['default'].div(templateObject_1$R || (templateObject_1$R = __makeTemplateObject(["\n  .enter,\n  .appear {\n    opacity: 0.01;\n  }\n\n  .enter.enter-active,\n  .appear.appear-active {\n    opacity: 1;\n    transition: opacity 250ms ease-in;\n  }\n\n  .exit {\n    opacity: 1;\n  }\n\n  .exit.exit-active {\n    opacity: 0.01;\n    transition: opacity 250ms ease-out;\n  }\n"], ["\n  .enter,\n  .appear {\n    opacity: 0.01;\n  }\n\n  .enter.enter-active,\n  .appear.appear-active {\n    opacity: 1;\n    transition: opacity 250ms ease-in;\n  }\n\n  .exit {\n    opacity: 1;\n  }\n\n  .exit.exit-active {\n    opacity: 0.01;\n    transition: opacity 250ms ease-out;\n  }\n"])));
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#add6dc", backgroundDisabled: "#E9EAEB", contrast: "#261d13", invertedContrast: "#67c0cf", input: "#f4efea", 
    // inputBorder: "#cccccc",
    inputSecondary: "#cccccc", tertiary: "#77c1cc", text: "#fff", textDisabled: "#9de3ef", textSubtle: "#fff", activeButton: "#397f49", borderColor: "#9de3ef", card: "#48a1af", nav: "#48a1af", priceBackground: "#FFFFFF", priceBorder: "#433734", gradients: {
